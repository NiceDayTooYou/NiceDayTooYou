...
const thai = {
  ...
  techCommunities: {
                        interest: "Oil painting, photography, English",
                        country: "People's Republic of China",
                        nick name: "Serendipity"
                      },
 challenge: "I want to say that I don’t know any of the above languages and tools."
}
```
...
# <h1><p align ="center"> 𝔻𝕠 𝕪𝕠𝕦 𝕜𝕟𝕠𝕨 ❤️ 𝕎𝕙𝕒𝕥 𝕚𝕥'𝕤 𝕃𝕆𝕍𝔼 <img src="https://media.giphy.com/media/ObNTw8Uzwy6KQ/giphy.gif" height="25px"> ℍ𝕒𝕡𝕡𝕪 𝕒𝕝𝕝 𝕕𝕒𝕪 𝕠𝕜𝕒𝕪? </p> </h1>
